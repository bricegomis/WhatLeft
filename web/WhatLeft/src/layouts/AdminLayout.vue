  ...
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <nav>
        ...
        <RouterLink to="/calendar" class="nav-link" active-class="active">Calendrier</RouterLink>
      ...
      <RouterLink to="/login" class="nav-link" active-class="active">Se connecter</RouterLink>
    </aside>
      ...
      <header class="topbar">
        ...
        <div class="user-card">
          ...
          <div>
            ...
            <small>whatleft@example.com</small>
          </div>
        </div>
      </header>
